...
- If any square has $|\text{surrounding mines}|=|\text{surrounding flags}|$, all other surrounding squares are safe
- If any square has $|\text{surrounding mines}|=|\text{surrounding uncovered squares}|$, they are all mines
