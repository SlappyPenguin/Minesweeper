...
- If any square has $\operatorname{num}(\text{surrounding mines}) = \operatorname{num}(\text{surrounding flags})$, all other surrounding squares are safe.
- If any square has $\operatorname{num}(\text{surrounding mines}) = \operatorname{num}(\text{surrounding uncovered squares})$, they are all mines.
